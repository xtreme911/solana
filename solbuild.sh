...
echo ''
echo ''
echo 'IF YOU ARE NOT RUNNING THIS AS THE SOLANA USERNAME PRESS [CONTROL-C] TO QUIT NOW'
echo ''
...
echo ''
echo 'THEN RETURN TO THIS TERMINAL AND PRESS [ENTER] KEY TO BEGIN COMPILING SOLANA'
echo ''
echo ''
read x
wait
